...
gnome-terminal --tab --title="navigation" -- bash -c "source ~/ws/devel/setup.bash; roslaunch robot_slam nav_conflict.launch; exec bash" &
...
gnome-terminal --tab --title="shoot_main" -- bash -c "source ~/ws/devel/setup.bash; echo '=== 射击程序启动 ==='; echo '等待3秒确保所有服务就绪...'; sleep 3; roslaunch abot_bringup conflect.launch; exec bash" &
sleep 2
